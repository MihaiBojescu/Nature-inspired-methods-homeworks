...
\includesvg[width = 250pt]{../images/hillclimber best score(dimension = 2).svg}

With the following runtimes:

\includesvg[width = 250pt]{../images/hillclimber runtimes(dimension = 2).svg}
...
\includesvg[width = 250pt]{../images/binary genetic algorithm fitness(dimension = 2).svg}

With the following runtimes:
\includesvg[width = 250pt]{../images/binary genetic algorithm runtimes(dimension = 2).svg}
...
\includesvg[width = 250pt]{../images/hybrid algorithm fitness(dimension = 2).svg}

In the following times:
\includesvg[width = 250pt]{../images/hybrid algorithm runtimes(dimension = 2).svg}
